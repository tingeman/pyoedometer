...
files = ['./sample_1/config_sample_1.yml',
         './sample_2/config_sample_2.yml',
         './sample_3/config_sample_3.yml',
         './sample_4/config_sample_4.yml',
         './sample_5/config_sample_5.yml',
         './sample_6/config_sample_6.yml'
         ]
...
for fname in files:
    ...
    for step_id, hist in enumerate(history):
        ...
        print('Processing step {0},  {1:.0f} kPa, {2:.0f} C'.format(hist['step'], hist['load'], hist['temp']))

...
print(" ")
print("If figures are not shown, you can issue the command `plt.show(block=False)` to display them.")
print("(provided that you are using an interactive Python interpreter, such as IPython)")